...
void Game::initGame(){
	...
	app.window = SDL_CreateWindow("Space Shooter", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, WIDTH, HEIGHT, SDL_WINDOW_SHOWN);
	if(!app.window){
    ...
    app.winScreen = loadTexture(winScreenTexture);
	app.running = false;
	...
	debrisTexture[0] = loadTexture("resources/sprites/debris1.png");
	debrisTexture[1] = loadTexture("resources/sprites/debris2.png");
	debrisTexture[2] = loadTexture("resources/sprites/debris3.png");
	debrisTexture[3] = loadTexture("resources/sprites/debris4.png");
...
void Game::updateScene(){
    ...
    if(score >=400 && Entities.effects.empty() && app.running){
        Entities.bullets.clear();
        Entities.debrises.clear();
        Entities.fighters.clear();
        Entities.powerUp.clear();
